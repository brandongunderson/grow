...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($username == "" || $email == "" || $password == "") {
        ...
        if ($stmt->fetch()) {
            ...
            // For demonstration, we set full_name equal to username. Adjust as needed.
            $stmt = $pdo->prepare("INSERT INTO users (username, full_name, email, password) VALUES (:username, :username, :email, :password)");
            $result = $stmt->execute([
                'username' => $username,
                'email'    => $email,
