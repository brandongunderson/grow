...
// Retrieve counts (using no status filter since no status column exists)
try {
    // Count all grows for this user
    $stmt = $pdo->prepare("SELECT COUNT(*) FROM grows WHERE user_id = ?");
    $stmt->execute([$user_id]);
    $activeGrowsCount = $stmt->fetchColumn();

    // Count all plants for this user
    $stmt = $pdo->prepare("SELECT COUNT(*) FROM plants WHERE user_id = ?");
    $stmt->execute([$user_id]);
    $activePlantsCount = $stmt->fetchColumn();

    // For grows completed, if no logic exists, we default to 0 (update later as needed)
    $completedGrowsCount = 0;
} catch (Exception $e) {
...
<div class="content-wrapper">
  ...
  <div class="container-xxl flex-grow-1 container-p-y">
      ...
      <div class="card-body row p-0 pb-6 g-6">
        <div class="col-12 col-lg-8 card-separator">
          <h5 class="mb-2">
            Welcome back, 
            <span class="h4">
              <?= isset($_SESSION['display_name']) && !empty($_SESSION['display_name']) ? htmlspecialchars($_SESSION['display_name']) : "?" ?>
            </span>
          </h5>
          <div class="col-12 col-lg-5">
            <p>Your progress this week is awesome. Let's keep it up and earn more rewards!</p>
          </div>
            ...
            <div class="d-flex align-items-center gap-4 me-6 me-sm-0">
              <div class="avatar avatar-lg">
                <div class="avatar-initial bg-label-success rounded">
                  <!-- Using existing Vuexy icon class for "Active Grows" (plant icon) -->
                  <i class="tf-icons ti ti-plant" style="font-size: 1.75rem;"></i>
                </div>
              </div>
              <div class="content-right">
                <p class="mb-0 fw-medium">Active Grows</p>
                <h4 class="text-success mb-0"><?= $activeGrowsCount ?></h4>
              </div>
            </div>
            <!-- Active Plants Card -->
            <div class="d-flex align-items-center gap-4">
              <div class="avatar avatar-lg">
                <div class="avatar-initial bg-label-info rounded">
                  <!-- Using existing Vuexy icon class for "Active Plants" (leaf icon) -->
                  <i class="tf-icons ti ti-leaf" style="font-size: 1.75rem;"></i>
                </div>
              </div>
              <div class="content-right">
                <p class="mb-0 fw-medium">Active Plants</p>
                <h4 class="text-info mb-0"><?= $activePlantsCount ?></h4>
              </div>
            </div>
            <!-- Grows Completed Card -->
            <div class="d-flex align-items-center gap-4">
              <div class="avatar avatar-lg">
                <div class="avatar-initial bg-label-warning rounded">
                  <!-- Using existing Vuexy icon class for "Grows Completed" (trophy icon) -->
                  <i class="tf-icons ti ti-trophy" style="font-size: 1.75rem;"></i>
                </div>
              </div>
              <div class="content-right">
                <p class="mb-0 fw-medium">Grows Completed</p>
                <h4 class="text-warning mb-0"><?= $completedGrowsCount ?></h4>
              </div>
            </div>
          </div>
        </div>
        <!-- Time Spending Chart Column -->
    ...
    <!-- End Dashboard Metrics Section -->

    <!-- Topic and Instructors Section -->
            ...
            <ul class="list-unstyled mb-0">
              <li class="d-flex mb-6 align-items-center">
                <div class="avatar flex-shrink-0 me-4">
                  <span class="avatar-initial rounded bg-label-primary"><i class="tf-icons ti ti-video ti-lg"></i></span>
                </div>
              ...
              <li class="d-flex mb-6 align-items-center">
                <div class="avatar flex-shrink-0 me-4">
                  <span class="avatar-initial rounded bg-label-info"><i class="tf-icons ti ti-code ti-lg"></i></span>
                </div>
                <div class="row w-100 align-items-center">
                  <div class="col-sm-8 mb-1 mb-sm-0 mb-lg-1 mb-xxl-0">
              ...
              <li class="d-flex mb-6 align-items-center">
                <div class="avatar flex-shrink-0 me-4">
                  <span class="avatar-initial rounded bg-label-success"><i class="tf-icons ti ti-camera ti-lg"></i></span>
                </div>
                <div class="row w-100 align-items-center">
                  <div class="col-sm-8 mb-1 mb-sm-0 mb-lg-1 mb-xxl-0">
              ...
              <li class="d-flex align-items-center">
                <div class="avatar flex-shrink-0 me-4">
                  <span class="avatar-initial rounded bg-label-danger"><i class="tf-icons ti ti-microphone-2 ti-lg"></i></span>
                </div>
                <div class="row w-100 align-items-center">
                  <div class="col-sm-8 mb-1 mb-sm-0 mb-lg-1 mb-xxl-0">
    ...
    <!-- End Topic and Instructors Section -->

    <!-- Course Datatable Section -->
    <div class="card">
